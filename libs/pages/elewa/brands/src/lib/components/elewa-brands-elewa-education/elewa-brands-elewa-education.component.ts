...
export class ElewaBrandsElewaEducationComponent {
  ...
  brandDescription = 'The secret to successful education is empathy. By understanding people and the holistic contexts in which they operate, Elewa Education develops proffesional training programs that are measured, sustainable, effective, and highly scalable. '
