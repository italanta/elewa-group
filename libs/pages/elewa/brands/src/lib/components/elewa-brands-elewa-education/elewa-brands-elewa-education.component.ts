...
export class ElewaBrandsElewaEducationComponent {
  ...
  brandDescription = 'The secret to successful education is empathy. By understanding people and the holistic contexts in which they operate, Elewa Education develops professional training programs that are measured, sustainable, effectve and highly scalable.'
