...
export class ElewaBrandsItalantaComponent {
  ...
  name = 'ITalanta';
  brandDescription = 'From Silicon Savannah to the world, iTalanta is an offshore tech development agency that doubles as a tech talent accelerator. iTalanta has a portfolio of clients consisting out of some of the hottest global startups.';
