...
export class ElewaBrandsVentureLabsComponent {
  ...
  name = 'Venture Labs';
  brandDescription = 'A moonshoot factory, Elewa Venture Labs invests and incubates gobal SaaS startups with high potential. Developed and grown by Elewa talents and our network.'
