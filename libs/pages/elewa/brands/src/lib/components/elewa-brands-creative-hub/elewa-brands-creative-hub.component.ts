...
export class ElewaBrandsCreativeHubComponent {
  ...
  @Input() creativeDescription = `Elewa Creative Hub is an upcoming creative space, located in the heart of Nairobi, which offers a safe place for Elewa talents and creatives to explore and grow.`;
