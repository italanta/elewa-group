  ...
  cards = [
    {
            subtitle: "Education",
						...
						description: 'A key player in the development and operations of a new-age human-centered digital learning experiences.',
						title: 'Elewa',
    },
    {
            subtitle: "Technology",
    ...
    },
    {
            ...
            description: 'Sometimes to grow means to let go.Our bravest move into Venture Labs,where our people they start and accelerate their own startups',
            title: 'Venture Labs',
}
  ]
}
