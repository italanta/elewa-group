...
@NgModule({
  ...
  exports: [HomePageComponent, HomeHeroSectionComponent, HomeJobsSectionComponent,CtaMissionComponent, TeamAndPartnersComponent, ActivitySectionComponent, NextDirective, PrevDirective],
