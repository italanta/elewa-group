...
@NgModule({
  ...
  imports: [CommonModule, InvestRoutingModule, LayoutModule, BannersModule],
  declarations: [InvestPageComponent,  ElewaInvestHeroComponent, ElewaInvestDetailSectionComponent,ElewaInvestCreativeHubSectionComponent, ElewaInvestStakeholderSectionComponent],
